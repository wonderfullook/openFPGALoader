...
static std::map <std::string, target_board_t> board_list = {
	...
	JTAG_BOARD("tangnano",        "GW1N-LV1QN48C6/I5", "ch552_jtag", 0, 0, CABLE_DEFAULT),
	JTAG_BOARD("tangnano1k",      "GW1NZ-LV1QN48C6/I5", "ft2232",     0, 0, CABLE_DEFAULT),
	JTAG_BOARD("tangnano4k",      "GW1NSR-LV4CQN48PC7/I6", "ft2232",     0, 0, CABLE_DEFAULT),
	JTAG_BOARD("tangnano9k",      "GW1NSR-LV9QN88PC6/I5", "ft2232",     0, 0, CABLE_DEFAULT),
	JTAG_BOARD("tangnano20k",     "GW2AR-LV18QN88C8/I7", "ft2232",     0, 0, CABLE_DEFAULT),
	JTAG_BOARD("tangprimer20k",   "GW2A-LV18PG256C8/I7", "ft2232",     0, 0, CABLE_DEFAULT),
